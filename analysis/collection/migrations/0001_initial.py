...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Report'
        db.create_table(u'collection_report', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'reports', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'collection', ['Report'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'collection_report')
