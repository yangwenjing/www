...
(function() {
  ...
  Draggable = (function() {
    function Draggable($container, selector, holder, callbacks) {
    ...
    Draggable.prototype.toggle = function(method) {
      ...
      this.$container[method]('mousedown touchstart', this.holder, this.began);
  ...
  Gridly = (function() {
    ...
    Gridly.prototype.draggable = function(method) {
      if (this._draggable == null) {
        this._draggable = new Draggable(this.$el, this.settings.draggable.selector, this.settings.draggable.holder, {
    ...
    Gridly.prototype.position = function($element, columns) {
      ...
      size = this.size($element);/*宽度占了多少行*/
      height = Infinity;
      column = 0;
      /*获取有多少行*/
