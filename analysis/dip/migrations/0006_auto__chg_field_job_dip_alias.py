...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Job.dip_alias'
        db.alter_column(u'dip_job', 'dip_alias', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Job.dip_alias'
        db.alter_column(u'dip_job', 'dip_alias', self.gf('django.db.models.fields.CharField')(max_length=32))
    ...
    models = {
        ...
        u'dip.job': {
            ...
            'dip_alias': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
