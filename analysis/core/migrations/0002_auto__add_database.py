...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_database', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'dbs', to=orm['auth.User'])),
            ('engine', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ...
        db.send_create_signal(u'core', ['Database'])


    def backwards(self, orm):
        # Deleting model 'Database'
        db.delete_table(u'core_database')
