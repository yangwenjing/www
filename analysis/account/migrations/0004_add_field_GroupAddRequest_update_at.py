...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupAddRequest.update_at'
        db.add_column(u'account_groupaddrequest', 'update_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 8, 5, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupAddRequest.update_at'
        db.delete_column(u'account_groupaddrequest', 'update_at')
